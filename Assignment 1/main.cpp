...
// Function which takes input from the user all the prices
vector<vector<string>>helper(vector<string> res,unordered_map<string,int>&m)
{
    unordered_set<string>unique_product;   // To store all the unique product code
...
// Function for getting price by passing product_code
// int getPrice(string str){
    
// }
// Function Used fro calculating number of price sold
...
// Function used for calculating total selling price
...
int main()
{
    ...
    */
    ...
    f_file<<"\t\t\t Astik Gorai\t\t"<<endl;
    f_file<<"\t\t\t2020CSB038"<<endl;
